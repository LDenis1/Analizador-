...
public class FrmPrincipal extends javax.swing.JFrame {
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case Else:
                    ...
                    break;
                case Do:
                    resultado += "  <Palabra Reservada do>\t" + lexer.lexeme + "\n";
                    break;
                case While:
    ...
    private void initComponents() {
        ...
        btnArchivo.setText("Cagar Archivo");
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        Sintax s = new Sintax(new pruebasintactico.LexerCup(new StringReader(ST)));
        
        try {
            s.parse();
            txtAnalizarSin.setText("Analisis realizado exitosamente!");
            txtAnalizarSin.setForeground(new Color(25, 111, 61));
        } catch (Exception ex) {
            Symbol sym = s.getS();
            //Indicar si existe error
